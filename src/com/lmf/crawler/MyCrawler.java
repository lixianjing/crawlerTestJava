...
public class MyCrawler extends WebCrawler {
	...
	public boolean shouldVisit(Page referringPage, WebURL url) {
		...
		boolean bool = !FILTERS.matcher(href).matches() && (href.startsWith("https://m.lianjia.com/bj/ershoufang/")
				|| href.startsWith("https:///bj.lianjia.com/ershoufang/")) && (href.endsWith("html"));
		System.out.println(bool + "==href==" + href);
		return bool;
	}
