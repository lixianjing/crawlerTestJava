...
public class HouseAPIDBManager {
	...
	public static final String JDBC_URL = "jdbc:MySQL://127.0.0.1:3306/crawler";// 数据库
	public static final String USER = "crawler"; // 用户名
	public static final String PASSWORD = "shui"; // 密码
