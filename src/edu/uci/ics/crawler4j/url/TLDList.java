 ...
 * local file) in order to compare against those TLDs
 */
public class TLDList {
	...
	/**
	 * If {@code online} is set to true, the list of TLD files will be downloaded
	 * and refreshed, otherwise the one cached in src/main/resources/tld-names.txt
	 * will be used.
	 */
